...
def display_account_info( portal_user, verbose ):
	...
	if verbose:
		...
		print("====================================")
		user_items = portal_user.items(max_items=200)
		item_number = len(user_items)
		print("Has ", str(item_number), " items")
		...
		print("====================================")
		user_provisions = portal_user.provisions
		provisions_number = len(user_provisions)
		print("Provisions with ", str(provisions_number))
		# groups are returned as a dictionary. Lets print the first dict as a sample
		i = 0
		while i < provisions_number:
			print(user_provisions[i])
			i += 1
